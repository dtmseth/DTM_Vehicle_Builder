...
Historical reference only. The active direction is [ROADMAP.md](../ROADMAP.md).
Root [AGENTS.md](../../AGENTS.md) governs verification; historical workflow instructions
below do not override it.

## Revisions 1.0–1.12 (July 2026)

These numbered revisions were stored in `AUDIT_REFACTOR_ROADMAP.md`, not `ROADMAP.md`.
They are preserved verbatim below. May–July decisions and the complete pre-refactor
roadmap follow, including superseded phase plans and schema sketches.
...
## Pre-refactor roadmap (preserved snapshot)
